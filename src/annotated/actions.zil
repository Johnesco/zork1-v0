@@ actions.zil - Zork I action routines
@@ Contains room description handlers, NPC behavior (troll, thief, cyclops),
@@ puzzle logic (exorcism, dam, coal mine, river/boat), light source management,
@@ and the full melee combat system with per-villain message tables.
"1ACTIONS for
...
@@ --- A SEEDY LOOKING GENTLEMAN... (the Thief NPC)
...
@@ --- LET THERE BE LIGHT SOURCES (lamp, candles, matches)
...
@@ --- OLD MAN RIVER... (river and boat mechanics)
...
@@ --- TOITY POIPLE BOIDS... (bat transport)
...
@@ --- CHUTES AND LADDERS (shaft, basket, coal machine)
