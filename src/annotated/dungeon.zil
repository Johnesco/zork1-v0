@@ dungeon.zil — Rooms & Objects (1DUNGEON)
@@ The complete world model for Zork I. The first half defines all game
@@ objects: items the player can interact with, treasures worth points,
@@ NPCs (thief, troll, cyclops), containers, and environmental props.
@@ The second half defines all rooms with their exits, descriptions,
@@ and local properties. SUBTITLE markers divide the map into regions.
"1DUNGEON for
