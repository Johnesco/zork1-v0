@@ FILE: syntax.zil
@@ Verb syntax definitions shared across the Zork trilogy.
@@ Defines buzzwords (ignored filler), preposition/direction synonyms,
@@ meta-game commands (save, restore, score, etc.), and SYNTAX declarations
@@ that map typed commands to V- verb routines with object-finding constraints.
		"Generic SYNTAX file for
		    The ZORK Trilogy
	       started on 7/21/83 by SEM"

@@ --- Buzzwords, Prepositions, and Direction Synonyms ---
